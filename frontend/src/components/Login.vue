...
<template>
  <div>
    ...
    <div class="grid place-items-center bg-gray-200">
      ...
      <div>
        <input v-model="username" type="text" placeholder="Enter your username" class="px-5 py-1 border-solid border-2 rounded-lg">
      </div>

      <!-- The password input box -->
      <div class="m-5">
        <input v-model="password" type="text" placeholder="Enter your password" class="px-5 py-1 border-solid border-2 rounded-lg">
      </div>

      <!-- The Login button -->
      <div class="m-5">
        <button @click="login" class="px-3 py-1.5 btn ml-2 border-green-500 bg-green-500 rounded-lg">LOGIN</button>
      </div>
    </div>
