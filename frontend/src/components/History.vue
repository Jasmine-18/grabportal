<template>
  <div class="h-screen-full bg-slate-300">
    <div class="dashboard p-4">
      ...
      <!-- Transaction History Chart / Making this only 1 div solves the error but need to figure out the flex-wrap part-->
      <div class="mt-2 lg:flex lg:gap-2">
        <div class="mt-2 bg-gray-800 p-5 w-full rounded-md box-border shadow">
          ...
          <!-- Place Columns dropdown button at top-right / Column dropdown button starts here-->
          <div class="float-right">
            <div class="relative">
              <!-- Dropdown toggle button -->
              <button @click="dropDownShow = !dropDownShow"
                class="flex items-center p-2 text-white bg-gray-600 rounded-md mt-2">
                <span class="mr-4">Filter by Columns</span>
              ...
              <!-- Dropdown menu -->
              <div v-show="dropDownShow" class="absolute left-0 py-2 mt-2 bg-gray-600 rounded-md w-44">
                <div class="flex block px-4 py-2 text-sm text-indigo-100 hover:bg-indigo-400 hover:text-indigo-100">
                ...
                <div class="flex block px-4 py-2 text-sm text-indigo-100 hover:bg-indigo-400 hover:text-indigo-100">
                  <label class="flex items-center">
                    <input class="flex item-center" type="checkbox" id="checkbox"
                      v-model="columnsChecked.transactionDate" @click="
                ...
                <div class="flex block px-4 py-2 text-sm text-indigo-100 hover:bg-indigo-400 hover:text-indigo-100">
                  <label class="flex items-center">
                    <input class="flex item-center" type="checkbox" id="checkbox"
                      v-model="columnsChecked.miTransactionID" @click="
          ...
          <!-- Download icon starts here -->
          <div class="wrapper-button mt-3 flex">
            <button class="float-right mt-3 border-b border-green-600 text-green-600">
              download with icon
            </button>
          </div>
          <!-- Download icon ends here -->
